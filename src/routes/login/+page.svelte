		...
		<div class="mb-4">
			...
			<div class="relative">			
				...
				<div class="absolute top-1.5 right-2">
					<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" stroke-width="1.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" on:click={togglePasswordVisibility} aria-label="Toggle password visibility">
						{#if showPassword}
